...
[p1,Fs1]=audioread('rockclassic.wav'); %read the audiorecording
p1=p1'; %take the transpose
p1=mean(p1);
tr=length(p1)/Fs1;

[p2,Fs2]=audioread('country.wav');
p2=p2';
p2=mean(p2);
tr2=length(p2)/Fs2;

[p3, Fs3]=audioread('swing.wav');
p3=p3';
p3=mean(p3);
tr3=length(p3)/Fs3;
%%
...
title('Diagonal Values for SVD for test case 3')
